...
bool LoadXML(const String &xml_file_name, vector<vector<KeyPoint>> &key_points,
	vector<Mat> &descriptors)
{
	FileStorage fs;
	if (!fs.open(xml_file_name, FileStorage::READ)) return false;
...
void ShowResult(int no)
{
	...
	case 9: cout << "图3-36 Wartsila38型柴油机连杆"; Show3DS("装配散件模型.3DS"); break;
